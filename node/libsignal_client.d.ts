...
export function SenderKeyDistributionMessage_New(chainId: number, iteration: number, chainkey: Buffer, pk: Wrapper<PublicKey>): SenderKeyDistributionMessage;
...
export function SenderKeyMessage_New(chainId: number, iteration: number, ciphertext: Buffer, pk: Wrapper<PrivateKey>): SenderKeyMessage;
...
export function SenderKeyName_GetId(obj: Wrapper<SenderKeyName>): string;
...
export function SenderKeyName_New(id: string, senderName: string, senderDeviceId: number): SenderKeyName;
